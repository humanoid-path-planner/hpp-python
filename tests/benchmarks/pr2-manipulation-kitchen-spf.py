...
robot.setJointBounds(
    "box/root_joint", [-5.1, -2, -5.2, -2.7, 0, 1.5, -2, 2, -2, 2, -2, 2, -2, 2]
)
...
q_init[rank : rank + 7] = [-2.5, -4, 0.9, 0, c, 0, c]
...
q_goal[rank] = -0.5
rank = robot.rankInConfiguration["box/root_joint"]
q_goal[rank : rank + 7] = [-4.8, -4.8, 0.9, 0, c, 0, c]
...
cg.addNumericalConstraintsToGraph([constraints[c] for c in locklhand])
