...
from pyhpp.core.static_stability_constraint_factory import StaticStabilityConstraintsFactory
...
constraints = factory.createSlidingStabilityConstraint("balance/", 'pyrene', leftAnkle,
                                        rightAnkle, q0)
...
problem.addNumericalConstraintsToConfigProjector("balance-proj", list(constraints.values()), [0]*len(constraints))
