...
# def apply_constraints(viewer, graph, configurationShooter, state):
#     for i in range(100):
#       q = configurationShooter.shoot()
#       res = graph.applyStateConstraints(state, q)
#       if res.success:
#         viz.display(res.configuration)
#         return res

# def check_transition(viewer, graph, configurationShooter, transition, state, start):
#     for i in range(100):
#         res1 = apply_constraints(viewer, graph, configurationShooter, state)
#         if not res1.success:
#             continue
#         res = cg.generateTargetConfig(transition, np.array(start), res1.configuration)
#         if res.success:
#             viz.display(res.configuration)
#             return res
#     viz.display(res.configuration)
...
# def test():
#     res = check_transition(viz, cg, problem.configurationShooter(),cg.getTransition("ur3/gripper > sphere0/handle | f_01"),cg.getState("ur3/gripper > sphere0/handle | f_pregrasp"), q_init)
#     print(res.success)
#     res = check_transition(viz, cg, problem.configurationShooter(),cg.getTransition("ur3/gripper > sphere0/handle | f_12"),cg.getState("ur3/gripper > sphere0/handle | f_intersec"), res.configuration)
#     print(res.success)
#     res = check_transition(viz, cg, problem.configurationShooter(),cg.getTransition("ur3/gripper > sphere0/handle | f_23"),cg.getState("ur3/gripper > sphere0/handle | f_preplace"), res.configuration)
#     print(res.success)
