...
class NonLinearSplineGradientBasedB3 (SplineGradientBasedAbstractB3):
    ...
    def optimize (self, path):
        ...
        solvers = self.SplineOptimizationDatas (splines.size(), self.SplineOptimizationData(rDof))
        ...
        value, jacobian = self.initValueAndJacobian (splines, validations, parameterizations)
    ...
    def computeJacobian (self, J, splines, validations, parameterizations):
        ...
        for k, (s,v,p) in enumerate(zip(splines, validations, parameterizations)):
            ...
            for f in p:
                ...
                for l in range(s.NbCoeffs):
                    J[ir:er, ics[l]:ics[l+1]] = JfunctionInit * paramDerInit[l,0] - JfunctionEnd * paramDerEnd[l,0]
                ir = er

        return J

    def computeLinearizedConstraint (self, constraint, value, J, splines, validations, parameterizations):
        self.computeValue (value, splines, validations, parameterizations)
