...
def test_path_api():
    ...
    path = pyhpp.core.StraightPath.create(space, np.array((0.0,)), np.array((1.0,)), pyhpp.core.interval(1.0, 2.0), None)
...
class PythonStraightPath(pyhpp.core.PathWrap):
    ...
    def impl_compute(self, param):
        ...
        return np.array([ self.a + param * self.v, ]), True
