...
!function(e, t) {
  ...
  function lt(o, e, t) {
    var n, a,
        r = 0, i = lt.prefilters.length, s = S.Deferred().always(function() {
          delete u.elem
        }),
        u =
            function() {
    ...
    removeAttr: function(e) {
      ...
      S.each(S.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        ft[t] = function(e, t, n) {
          ...
          return n ||
                     (i = ft[o], ft[o] = r, r = null != a(e, t, n) ? o : null,
                      ft[o] = i),
                 r
        }
      });
  ...
  function At(n, e, r, i) {
    ...
    if (Array.isArray(e))
      S.each(e, function(e, t) {
        r || Ct.test(n) ?
            i(n, t) :
            At(n + '[' + ('object' == typeof t && null != t ? e : '') + ']', t,
               r, i)
      });
...
!function(t) {
    ...
    y.fn[o] = function(i) {
      ...
      return t ? this.length || 'instance' !== i ? this.each(function() {
        ...
        return 'instance' === i ?
            ...
            y.error(
                'no such method \'' + i + '\' for ' + o + ' widget instance') :
  ...
  y.Widget.prototype = {
    ...
    _createWidget: function(t, e) {
      ...
      e !== this &&
          (y.data(e, this.widgetFullName, this), this._on(!0, this.element, {
            remove: function(t) {
    ...
    _on: function(n, o, t) {
      ...
      'boolean' != typeof n && (t = o, o = n, n = !1),
          ...
          y.each(t, function(t, e) {
            ...
            var s = t.match(/^([\w:-]*)\s*(.*)$/), t = s[1] + a.eventNamespace,
                s = s[2];
  ...
  y.each({show: 'fadeIn', hide: 'fadeOut'}, function(o, h) {
    y.Widget.prototype['_' + o] = function(e, t, i) {
      ...
      'number' == typeof (t = t || {}) ?
          t = {duration: t} :
          !0 === t && (t = {}),
          s = !y.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay),
  ...
  x = Math.max, D = Math.abs, o = /left|center|right/, r = /top|center|bottom/,
  l = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, p = /%$/, W = y.fn.position,
  y.position = {
    scrollbarWidth: function() {
      ...
      return y('body').append(e),
             ...
             t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(),
             s = t - i
    },
    ...
    getWithinInfo: function(t) {
      var e = y(t || window), i = S(e[0]), s = !!e[0] && 9 === e[0].nodeType;
      return {
  ...
  y.fn.position = function(p) {
    ...
    var d, c, f, g, m, t,
        ...
        y(p.of),
        w = y.position.getWithinInfo(p.within), v = y.position.getScrollInfo(w),
    ...
    return _[0].preventDefault && (p.at = 'left top'),
           ...
           y.each(
               ...
               function() {
                 ...
                 (i = 1 === i.length ?
                      ...
                      i[1] = r.test(i[1]) ? i[1] : 'center', t = l.exec(i[0]),
                      e = l.exec(i[1]), z[this] = [t ? t[0] : 0, e ? e[0] : 0],
           ...
           this.each(function() {
             var i, t, h = y(this), a = h.outerWidth(), r = h.outerHeight(),
                       e = H(this, 'marginLeft'), s = H(this, 'marginTop'),
                       n = a + e + H(this, 'marginRight') + v.width,
                       o = r + s + H(this, 'marginBottom') + v.height,
                       l = y.extend({}, m),
                       u = E(z.my, h.outerWidth(), h.outerHeight());
             'right' === p.my[0] ? l.left -= a :
    ...
    fit: {
      left: function(t, e) {
        var i = e.within, s = i.isWindow ? i.scrollLeft : i.offset.left,
            n = i.width, o = t.left - e.collisionPosition.marginLeft, h = s - o,
      ...
      top: function(t, e) {
        var i = e.within, s = i.isWindow ? i.scrollTop : i.offset.top,
            n = e.within.height, o = t.top - e.collisionPosition.marginTop,
            h = s - o, a = o + e.collisionHeight - n - s;
        e.collisionHeight > n ?
            0 < h && a <= 0 ?
            (i = t.top + h + e.collisionHeight - n - s, t.top += h - i) :
            t.top = !(0 < a && h <= 0) && a < h ? s + n - e.collisionHeight :
                                                  s :
            0 < h ? t.top += h :
            0 < a ? t.top -= a :
      ...
      left: function(t, e) {
        var i = e.within, s = i.offset.left + i.scrollLeft, n = i.width,
            ...
            'right' === e.at[0]    ? -e.targetWidth :
                                     0,
            h = -2 * e.offset[0];
        a < 0 ? ((s = t.left + l + i + h + e.collisionWidth - n - s) < 0 ||
                 s < D(a)) &&
                (t.left += l + i + h) :
                0 < r &&
                (0 < (o = t.left - e.collisionPosition.marginLeft + l + i + h -
                          o) ||
                 D(o) < r) &&
                (t.left += l + i + h)
      },
      top: function(t, e) {
        var i = e.within, s = i.offset.top + i.scrollTop, n = i.height,
            ...
            'bottom' === e.at[1]  ? -e.targetHeight :
                                    0,
            h = -2 * e.offset[1];
        a < 0 ? ((s = t.top + l + i + h + e.collisionHeight - n - s) < 0 ||
                 s < D(a)) &&
                (t.top += l + i + h) :
                0 < r &&
                (0 < (o = t.top - e.collisionPosition.marginTop + l + i + h -
                          o) ||
                 D(o) < r) &&
                (t.top += l + i + h)
      }
  ...
  y.fn.labels =
      function() {
    var t, e, i;
    return this.length ? this[0].labels && this[0].labels.length ?
  ...
  y.widget('ui.mouse', {
    ...
    _mouseInit: function() {
      ...
      this.element
          ...
          .on('click.' + this.widgetName,
              function(t) {
                if (!0 ===
                    y.data(t.target, e.widgetName + '.preventClickEvent'))
                  return y.removeData(
            ...
            (this.mouseDelayMet = !this.options.delay,
             ...
             this._mouseDistanceMet(t) && this._mouseDelayMet(t) &&
                 ...
                 (!0 ===
                      ...
                      y.removeData(
                          t.target, this.widgetName + '.preventClickEvent'),
                  this._mouseMoveDelegate =
                      function(t) {
    ...
    _mouseMove: function(t) {
      if (this._mouseMoved) {
        if (y.ui.ie && (!document.documentMode || document.documentMode < 9) &&
            !t.button)
  ...
  y.widget('ui.resizable', y.ui.mouse, {
    ...
    _setupHandles: function() {
      ...
      if (this.handles = o.handles ||
        ...
        for ('all' === this.handles && (this.handles = 'n,e,s,w,se,sw,ne,nw'),
          ...
          n = y('<div>'), this._addClass(n, 'ui-resizable-handle ' + s),
          n.css({zIndex: o.zIndex}), this.handles[t] = '.ui-resizable-' + t,
      ...
      this._renderAxis =
        ...
        for (e in t = t || this.element, this.handles)
          this.handles[e].constructor === String ?
              this.handles[e] =
                  this.element.children(this.handles[e]).first().show() :
    ...
    _mouseCapture: function(t) {
      ...
      for (e in this.handles)
        (i = y(this.handles[e])[0]) !== t.target && !y.contains(i, t.target) ||
            (s = !0);
    ...
    _mouseStop: function(t) {
      ...
      return this._helper &&
                 (s = (e = (i = this._proportionallyResizeElements).length &&
                  ...
                  o.helper.height(o.size.height), o.helper.width(o.size.width),
    ...
    _updateRatio: function(t) {
      ...
      return this._isNumber(t.height) ? t.width = t.height * this.aspectRatio :
    ...
    ui: function() {
      ...
      y.ui.plugin.add('resizable', 'containment', {
              ...
              (n.containerElement = y(h),
               /document/.test(o) || o === document ?
                   ...
                   (i = y(h), s = [],
                    ...
                    n.containerPosition = i.position(), n.containerSize = {
                    ...
                    e = n._hasScroll(h) ? h.scrollHeight : e, n.parentData = {
                      element: h,
                      left: t.left,
                      top: t.top,
                      width: o,
        ...
        stop: function() {
          ...
          t._helper && !e.animate && /relative/.test(n.css('position')) &&
              ...
              t._helper && !e.animate && /static/.test(n.css('position')) &&
      ...
      y.ui.plugin.add('resizable', 'alsoResize', {
        ...
        resize: function(t, i) {
          ...
          y(s.alsoResize).each(function() {
            var t = y(this), s = y(this).data('ui-resizable-alsoresize'),
                n = {},
      ...
      y.ui.plugin.add('resizable', 'grid', {
        resize: function() {
          var t, e = y(this).resizable('instance'), i = e.options, s = e.size,
                 n = e.originalSize, o = e.originalPosition, h = e.axis,
                 a = 'number' == typeof i.grid ? [i.grid, i.grid] : i.grid,
                 r = a[0] || 1, l = a[1] || 1,
                 u = Math.round((s.width - n.width) / r) * r,
                 p = Math.round((s.height - n.height) / l) * l, d = n.width + u,
                 c = n.height + p, f = i.maxWidth && i.maxWidth < d,
          ...
          /^(se|s|e)$/.test(h) ?
              ...
              ((c - l <= 0 || d - r <= 0) &&
               ...
               0 < c - l ? (e.size.height = c, e.position.top = o.top - p) :
                           (c = l - t.height, e.size.height = c,
                            e.position.top = o.top + n.height - c),
               0 < d - r ? (e.size.width = d, e.position.left = o.left - u) :
      ...
      if (null !== a) {
        ...
        $.each(b.axis.split(''), function(a, c) {
          ...
          t ? (f[g] = t[m] + (l ? 0 : h - r.offset()[m]),
              ...
              (d = e[m],
               f[g] = d.slice && '%' === d.slice(-1) ? parseFloat(d) / 100 * n :
                                                       d);
          b.limit && /^\d+$/.test(f[g]) &&
...
function PlacementCalculator() {
  function computePlacementCoords(
    ...
    var placementBase = placement.split('-')[0], coords = new CSSCoordinates,
        position;
  ...
  function getSvgPlacement(element, placement) {
    var svgElement = element.closest('svg')[0], domElement = element[0],
        point = svgElement.createSVGPoint(), boundingBox = domElement.getBBox(),
        matrix = domElement.getScreenCTM(), halfWidth = boundingBox.width / 2,
        halfHeight = boundingBox.height / 2, placements = [],
        placementKeys = ['nw', 'n', 'ne', 'e', 'se', 's', 'sw', 'w'], coords,
        rotation, steps, x;
      ...
      if (collisions !== Collision.none) {
        ...
        if (collisionCount === 1) {
          if (collisions === Collision.right) {
            coords.set(
                'left', session.scrollLeft + session.windowWidth - tipWidth)
          } else if (collisions === Collision.bottom) {
            coords.set(
                'top', session.scrollTop + session.windowHeight - tipHeight)
          }
        } else {
...
!function(a) {
  function f(a, b) {
    if (!(a.originalEvent.touches.length > 1)) {
      ...
      d.initMouseEvent(
          b, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1,
          !1, !1, !1, 0, null),
  ...
  if (a.support.touch = 'ontouchend' in document, a.support.touch) {
    ...
    b._touchStart = function(a) {
      ...
      !e && b._mouseCapture(a.originalEvent.changedTouches[0]) &&
          (e = !0, b._touchMoved = !1, f(a, 'mouseover'), f(a, 'mousemove'),
           f(a, 'mousedown'))
    }, b._touchMove = function(a) {
      e && (this._touchMoved = !0, f(a, 'mousemove'))
    }, b._touchEnd = function(a) {
      e &&
          (f(a, 'mouseup'), f(a, 'mouseout'), this._touchMoved || f(a, 'click'),
           e = !1)
           ...
           prototype: {
             ...
             isFixed: function() {
               ...
               return t || this.$root.parentsUntil('body').each(function() {
                 return 'fixed' == $(this).css('position') ? (t = !0, !1) :
                                                             void 0
               }),
                      t
             },
             ...
             itemClick: function(t) {
               ...
               if (this.handleItemEvents(e)) {
                 if (this.$touchScrollingSub &&
                   ...
                   return this.$touchScrollingSub = null, t.stopPropagation(),
                          !1;
                 if (this.$root.triggerHandler('click.smapi', e[0]) === !1)
                   return !1;
                 var i = $(t.target).is('.sub-arrow'), s = e.dataSM('sub'),
               ...
               this.handleItemEvents(e) &&
                   (!this.focusActivated ||
                        ...
                        this.activatedItems.length &&
                            this.activatedItems[this.activatedItems.length - 1]
                                               [0] == e[0] ||
             ...
             menuPosition: function(t) {
               var e, i,
                   s = t.dataSM('parent-a'), o = s.closest('li'),
                   a = o.parent(), n = t.dataSM('level'), r = this.getWidth(t),
                   h = this.getHeight(t), u = s.offset(), l = u.left, c = u.top,
                   d = this.getWidth(s), m = this.getHeight(s), p = $(window),
                   f = p.scrollLeft(), v = p.scrollTop(),
               ...
               if (g ? (e = M ? d - r - w : w,
                 ...
                 if (M && f > y ? e = g ? f - y + e : d - w :
                   ...
                   if (t.dataSM('scroll', {
                          ...
                          subH: h,
                          arrowDownH:
                              this.getHeight(t.dataSM('scroll-arrows').eq(1))
                        })
                           .on(getEventsNS(
                               {
             ...
             menuScroll: function(t, e, i) {
               ...
               if (!e && o.momentum) {
                 ...
                 s = i ||
                     (e || !this.opts.scrollAccelerate ? this.opts.scrollStep :
                                                         Math.floor(o.step));
               ...
               if (this.activatedItems[r - 1] &&
                 ...
                 this.opts.scrollAccelerate && o.step < this.opts.scrollStep &&
                     (o.step += .2);
                 var h = this;
             ...
             menuScrollStop: function(t) {
               return this.scrollTimeout ?
                   (cancelAnimationFrame(this.scrollTimeout),
                    this.scrollTimeout = 0, t.dataSM('scroll').step = 1, !0) :
                   void 0
             },
                     ...
                     void 0 !== s.touchY &&
                         ((s.momentum = 15 *
                               Math.pow(
                                   ...
                                   2)) &&
                              (this.menuScrollStop(t), this.menuScroll(t),
                               e.preventDefault()),
                          delete s.touchY)
                 }
               }
             ...
             menuShow: function(t) {
               if ((t.dataSM('beforefirstshowfired') ||
                   ...
                   (t.dataSM('shown-before', !0), canAnimate && t.stop(!0, !0),
                    !t.is(':visible'))) {
                   ...
                   if (t.css(
                       ...
                       (this.opts.subMenusMinWidth ||
                        this.opts.subMenusMaxWidth) &&
                           (t.css({width: 'auto', minWidth: '', maxWidth: ''})
                                .addClass('sm-nowrap'),
                            this.opts.subMenusMinWidth &&
