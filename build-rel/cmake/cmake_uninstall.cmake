...
if(NOT EXISTS
   "/home/psardin/devel/nix-hpp/src/hpp-python/build-rel/install_manifest.txt")
  return()
endif(
  NOT EXISTS
  "/home/psardin/devel/nix-hpp/src/hpp-python/build-rel/install_manifest.txt")
...
if(EXISTS "/home/psardin/devel/nix-hpp/install/.catkin"
   AND PACKAGE_CREATES_DOT_CATKIN)
  message(STATUS "Try to remove /home/psardin/devel/nix-hpp/install/.catkin")
  execute_process(
    COMMAND ${CMAKE_COMMAND} -E remove
            "/home/psardin/devel/nix-hpp/install/.catkin"
  ...
  if(EXISTS "$ENV{DESTDIR}${file}")
    ...
    if(file MATCHES ".py$")
      ...
      if(EXISTS "$ENV{DESTDIR}${pycfile}")
        ...
        if(NOT ${rm_resval} STREQUAL 0)
          message(
            FATAL_ERROR "Problem when removing \"$ENV{DESTDIR}${pycfile}\"")
        endif(NOT ${rm_resval} STREQUAL 0)
