...
namespace pyhpp {
  namespace core {
    ...
    void exposeReports ()
    {
      ...
      class_ <CollisionValidationReport, CollisionValidationReportPtr_t, bases<ValidationReport> >
        ("CollisionValidationReport", no_init)
      ...
      class_ <JointBoundValidationReport, JointBoundValidationReportPtr_t, bases<ValidationReport> >
        ("JointBoundValidationReport", no_init)
      ...
      class_ <PathValidationReport, PathValidationReportPtr_t, bases<ValidationReport> >
        ("PathValidationReport", no_init)
        .def_readwrite ("parameter"          , &PathValidationReport::parameter)
        .def_readwrite ("configurationReport", &PathValidationReport::configurationReport)
        ;
