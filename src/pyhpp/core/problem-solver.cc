...
using namespace hpp::core;
  ...
  static tuple pathValidationType
  (const ProblemSolver& ps) {
    value_type tol;
  ...
  void exposeProblemSolver() {
    ...
    class_<ProblemSolver>("ProblemSolver", no_init)
      ...
      .staticmethod("create")
      .def("problem", static_cast<ProblemPtr_t (ProblemSolver::*)()>
           (&ProblemSolver::problem), return_value_policy<return_by_value>())
      ...
      PYHPP_DEFINE_METHOD2(ProblemSolver, solve,
      ...
      .def("addObstacle",
           static_cast<void (ProblemSolver::*)(const hpp::pinocchio::DevicePtr_t&,
                                               bool, bool)>
           (&ProblemSolver::addObstacle), DocClassMethod(addObstacle))
