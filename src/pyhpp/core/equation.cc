...
void exposeEquation() {
  class_<Equation, EquationPtr_t, boost::noncopyable>("Equation", no_init)
      PYHPP_DEFINE_GETTER_SETTER_INTERNAL_REF(Equation, comparisonType,
          ...
          .def(self ==
               self)  // equivalent to .def ("__eq__", &Equation::operator==)
      ;

  class_<NumericalConstraint, NumericalConstraintPtr_t, boost::noncopyable,
         bases<Equation> >("NumericalConstraint", no_init)
  ...
  class_<ExplicitNumericalConstraint, ExplicitNumericalConstraintPtr_t,
         boost::noncopyable, bases<NumericalConstraint> >(
      ...
      PYHPP_DEFINE_METHOD(ExplicitNumericalConstraint, explicitFunction)
          PYHPP_DEFINE_METHOD(ExplicitNumericalConstraint, outputFunction)
              PYHPP_DEFINE_METHOD(ExplicitNumericalConstraint,
                                  outputFunctionInverse)
                  PYHPP_DEFINE_METHOD_INTERNAL_REF(ExplicitNumericalConstraint,
                                                   inputConf)
                      PYHPP_DEFINE_METHOD_INTERNAL_REF(
                          ExplicitNumericalConstraint, inputVelocity)
                          PYHPP_DEFINE_METHOD_INTERNAL_REF(
                              ExplicitNumericalConstraint, outputConf)
                              PYHPP_DEFINE_METHOD_INTERNAL_REF(
                                  ExplicitNumericalConstraint, outputVelocity);

  class_<LockedJoint, LockedJointPtr_t, boost::noncopyable,
         bases<ExplicitNumericalConstraint> >("LockedJoint", no_init)
      PYHPP_DEFINE_METHOD_INTERNAL_REF(LockedJoint, jointName)
          PYHPP_DEFINE_METHOD(LockedJoint, configSize)
              PYHPP_DEFINE_METHOD(LockedJoint, numberDof) PYHPP_DEFINE_METHOD(
  ...
  class_<LockedJoints_t>("LockedJoints")
      .def(cpp_like_vector_indexing_suite<LockedJoints_t, true>());
}
}  // namespace core
}  // namespace pyhpp
